cmd_arch/arm/mach-imx/spl_sd.cfg.cfgtmp := aarch64-poky-linux-gcc -E -Wp,-MD,arch/arm/mach-imx/.spl_sd.cfg.cfgtmp.d  -nostdinc -isystem /home/duxy/opt/fsl-imx-wayland/4.14-sumo/sysroots/x86_64-pokysdk-linux/usr/lib/aarch64-poky-linux/gcc/aarch64-poky-linux/7.3.0/include -Iinclude   -I./arch/arm/include -include ./include/linux/kconfig.h -D__KERNEL__ -D__UBOOT__    -D__ARM__           -fno-pic  -mstrict-align  -ffunction-sections -fdata-sections -fno-common -ffixed-r9    -fno-common -ffixed-x18 -pipe -march=armv8-a -mgeneral-regs-only -D__LINUX_ARM_ARCH__=8     -x c -o arch/arm/mach-imx/spl_sd.cfg.cfgtmp arch/arm/mach-imx/spl_sd.cfg
